...
* I rarely have generated outputs from this type of study in R.  I often tend to export my raw data to Excel and generate Excel-based outputs for my internal clients.  Often, my materials are post-processed by other team members to make more polished outputs for reporting; in most cases, the critical outputs tend to be the future market scenarios and the identificiation of the optimal product configurations.
